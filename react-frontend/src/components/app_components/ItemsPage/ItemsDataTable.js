...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.color}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.price}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="name" header="Product Name" body={dropdownTemplate0} filter={selectedFilterFields.includes("name")} hidden={selectedHideFields?.includes("name")}  style={{ minWidth: "8rem" }} />
<Column field="qty" header="Qty" body={pTemplate1} filter={selectedFilterFields.includes("qty")} hidden={selectedHideFields?.includes("qty")}  sortable style={{ minWidth: "8rem" }} />
<Column field="color" header="Color" body={pTemplate2} filter={selectedFilterFields.includes("color")} hidden={selectedHideFields?.includes("color")}  sortable style={{ minWidth: "8rem" }} />
