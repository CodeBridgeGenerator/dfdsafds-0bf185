...
const dropdownTemplate1 = (rowData, { rowIndex }) => <p >{rowData.customer?.name}</p>
...
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.delivery}</p>
...
<Column field="subtotal" header="Subtotal" body={pTemplate2} filter={selectedFilterFields.includes("subtotal")} hidden={selectedHideFields?.includes("subtotal")}  sortable style={{ minWidth: "8rem" }} />
<Column field="totalamount" header="Total amount" body={pTemplate3} filter={selectedFilterFields.includes("totalamount")} hidden={selectedHideFields?.includes("totalamount")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="delivery" header="Delivery" body={pTemplate5} filter={selectedFilterFields.includes("delivery")} hidden={selectedHideFields?.includes("delivery")}  sortable style={{ minWidth: "8rem" }} />
